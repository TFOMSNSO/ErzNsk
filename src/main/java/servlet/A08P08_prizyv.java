...
@WebServlet(urlPatterns = "/process_A08P08_prizyv")
public class A08P08_prizyv extends HttpServlet {

    public A08P08_prizyv(){}
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("A08P08_prizyv JSON:" + fg2);
        ...
        System.out.println("JSON ANSWER:" + json);
    }
...
//								 //оставляем енп
                                if(f2.get(39).trim().equals("")){
                                    f1.set(3, f2.get(26));
                                } else {
                                    f1.set(3, f2.get(39));
                                }

                                String enpFind = f1.get(3);
                                String dateOtrk = findDate(enpFind);
                                // фамилия
                                f1.set(4, f2.get(0));
                                // имя
                                f1.set(5, f2.get(1));
    ...
    private String findDate(String enp){
        ...
        try {
            ...
            resultSet = statement.executeQuery("select trunc(date_vosstanovl) from WW_PRIZYV w where w.enp_vnutr = " + enp);
