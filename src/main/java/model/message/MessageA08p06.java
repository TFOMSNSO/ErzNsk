...
public class MessageA08p06 extends MessageCommon {
	
	public MessageA08p06() {
		super();
		// TODO Auto-generated constructor stub
	}

	public MessageA08p06(int pERSON_SERDOC, int pERSON_NUMDOC,
	...
	protected void createMiddle(int count, Namespace namespace,
		...
		for (int i = 1; i < count; i++) {
			...
			in1_1.addContent(new Element("IN1.12", namespace).addContent(dataList.get(i).get(VS_DATE)));
	
			in1_1.addContent(new Element("IN1.13", namespace).addContent(dataList.get(i).get(VS_DATEPLUS1)));
	
			in1_1.addContent(new Element("IN1.15", namespace).addContent("50000"));
		
			in1_1.addContent(new Element("IN1.35", namespace).addContent("Â"));
			
			in1_1.addContent(new Element("IN1.36", namespace).addContent(dataList.get(i).get(VS_NUM)));
