...
public class MessageA08p01 extends MessageCommon {
	
	public MessageA08p01() {
		super();
		// TODO Auto-generated constructor stub
	}

	public MessageA08p01(int pERSON_SERDOC, int pERSON_NUMDOC,
	...
	protected void createMiddle(int count, Namespace namespace,	Element rootElement, String curDate) {
		...
		for (int i = 1; i < count; i++) {
			...
			evn.addContent(new Element("EVN.4", namespace).addContent("Ï01"));
