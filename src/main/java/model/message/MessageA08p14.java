...
public class MessageA08p14 extends MessageCommon {
	
	public MessageA08p14() {
		super();
		// TODO Auto-generated constructor stub
	}

	public MessageA08p14(int pERSON_SERDOC, int pERSON_NUMDOC,
	...
	protected void createMiddle(int count, Namespace namespace,
		...
		for (int i = 1; i < count; i++) {
			...
			evn.addContent(new Element("EVN.4", namespace).addContent("Ï14"));
