...
public class MessageA08p03pr_anouthOkato extends MessageImpl {

	public MessageA08p03pr_anouthOkato(FileTransfer fileTransfer, ResObject res, Data data) {
	...
	protected void createMiddle(Namespace namespace,
		...
		in1_1.addContent(new Element("IN1.18", namespace).addContent(data.getLast_dr()));
