...
<jsp:include page="../WEB-INF/pages/template.jsp">
	<jsp:param value="Открепленные ZP3" name="pageTitle"/>
	<jsp:param value="<div id='chartContainer' style='width: 100%; height: 600px;display: inline-block;'/><br>" name="content"/> 	
</jsp:include>
...
map = new HashMap<Object,Object>(); map.put("x", 451);  map.put("y", 13000); list.add(map);
   ...
   $(function () {
       var chart = new CanvasJS.Chart("chartContainer", {
           ...
           title: {
        	   fontSize: 20,
        	   fontStyle: "italic",
           	   text: "Динамика открепленных застрахованных лиц в региональном сегменте Новосибирской области по информации ЦС ЕРЗ (ZP3)",
           },
           legend: {
       			fontSize: 15
       		},
           ...
           axisY2: {
               title: "Количество накопительным итогом",
               includeZero: false,
               suffix: " всего чел",
               labelFontSize: 10,
               titleFontSize: 17,
