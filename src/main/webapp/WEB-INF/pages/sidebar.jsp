...
<div id="sidebar" class="sidebar-toggle">
	<ul class="nav nav-sidebar">
		...
		<li data-toggle="collapse" href="#zp3" aria-expanded="true"
			aria-controls="zp3"><a href="#"> <i
				class="fa fa-area-chart" aria-hidden="true"></i><span>Открепленные ZP3</span>
			</a>
		</li>
		<li>
			<ul id="zp3" class="sub-menu collapse ${fn:contains(pageContext.request.requestURI,'chart-types') ? 'in' : ''}">
				<li><a href="${pageContext.request.contextPath}/features/zp3_1.jsp">Отчет №1</a></li>
			</ul>
		</li>
		<li role="separator" class="divider"></li>
		<!-- chart types -->
